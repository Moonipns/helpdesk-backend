...
public class DBService {
	...
	public void instanciaDB() {
		Tecnico tec1 = new Tecnico(null, "Monique Nunes", "31397127236", "monique@mail.com", encoder.encode("123"));
		tec1.addPerfil(Perfil.ADMIN);
		
		Cliente cli1 = new Cliente(null, "Everton Lima", "57667088748", "everton@mail.com", encoder.encode("123"));
